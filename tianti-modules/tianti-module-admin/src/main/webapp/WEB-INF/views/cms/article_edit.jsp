...
<body <%@ include file="../common/skin.jsp" %>>
  ...
  <div class="J_content">
	<div class="mt20 plr20">
		...
		<form action="${ctx}/cms/article/ajax/save" id="editForm" name="editForm" method="post">
				...
				<td>
					<div class="J_toolsBar fl">
					  <div class="t_opacitySelect ml10">
					   <span>请选择</span>
					   <select id="rootColumnId" name="rootColumnId"  style="min-width:200px"><!-- onChange = "selectLeafColumn()" -->
			...
			<tr>
				...
				<td>
					<div class="J_toolsBar fl">
					    <div class=" w200 ml10">
							<label> 
								<input type="file" name="attachImage" id="attachImage" value="选择文件ddd" /> 
							</label>
						</div>
					</div>
				</td>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/uploadify/jquery.uploadify.js"></script>
	<script type="text/javascript">
		//表单验证
		$(document).ready(function(){
			console.log($(':input[form="editForm"]'));
			$('#editForm').validator({
				fields : {
...
// 					});
			...
			$("#attachImage").uploadify(
			  {
				swf : '${pageContext.request.contextPath}/static/js/uploadify/uploadify.swf?getSessionId()='+getSessionId(),
				uploader : '${pageContext.request.contextPath}/upload/uploadAttach?jsessionid='+getSessionId(),
				...
				height : 20,
				uploadLimit:3,
				scriptData: { JSESSIONID: getSessionId()},
...
//                     alert(file.name);
//                 },
// 			 'onUploadComplete': function(file){alert("onUploadComplete")
//                     //在每一个文件上传成功或失败之后触发，返回上传的文件对象或返回一个错误，如果你想知道上传是否成功，最后使用onUploadSuccess或onUploadError事件
//                 }
// 		   });
		});
