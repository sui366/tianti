...
window.server = "http://localhost:8091";//接口地址项目（tianti-module-interface）部署（以用户自己实际情况来定）http://119.29.102.182:8090/interfaces
//window.serverPath = window.server + "tianti-module-interface/";
window.serverPath = window.server;
//后台上传的图片地址
window.serverUploadPath = "http://localhost:8093"//http://119.29.102.182:8090/admin
