...
jc.uiExtend("footer", {
    template: function (data) {
        ...
        html += '<h4>关于 杭州西顺</h4>';
        html += '<p class="mt20"><i class="icon"></i>地址：杭州西顺</p>'
        html += '<p><i class="icon"></i>邮箱：sui366@163.com</p>'
        html += '</div>';
        ...
        html += '版权所有 ****杭州西顺 Copyright © 1998 - 2017 Tencent. All Rights Reserved';
        html += '<span>*公网安备12345659473</span>';
        html += '</div>';
        html += '</div>';
...
jc.uiExtend("pageBanner", {
    init: function () {
        this.$element.html('<img src="../../static/cache/2.jpg" />');
    }
});
